...
let persons= [
 ...
 router.post("/votingAge",function(req,res){
    // let legalAge = req.query.legalVotingAge
    // for(i =0; i<persons.length;i++){
    //     if (persons.votingStatus = votingStatus>18)
    //     return res.send(votingStatus = true)
    // };
 })
 ...
 //  router.post("/legalAge",function(req,res){
 //     let eligiblity = req.query.legalVotingAge;
 //     let canVote = persons.filter(x=> x.age>=eligiblity);
 //     canVote.map(x=> x.votingStatus =true)
 //     return res.send(canVote)
 //  })